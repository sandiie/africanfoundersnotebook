...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section id="home" className="bg-[#F7F5EF] text-[#18251F] overflow-hidden">
      {/* =========================
          TOP NAVIGATION
          ========================= */}
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 pt-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              aria-label="African Founders Notebook"
            >
              <div className="flex flex-col gap-[3px]">
                <span className="block w-8 h-[3px] rounded-full bg-[#1677C8]" />
                <span className="block w-8 h-[3px] rounded-full bg-[#159447]" />
                <span className="block w-8 h-[3px] rounded-full bg-[#F2C230]" />
              </div>

              <div>
                <div className="text-[9px] tracking-[0.28em] uppercase text-white/65">
                  Research Initiative
                </div>
                <div className="font-serif text-lg sm:text-xl text-white leading-none mt-1">
                  African Founders{' '}
                  <span className="italic text-white/85">Notebook</span>
                </div>
              </div>
            </button>
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <button
                onClick={() => scrollToSection('matters')}
                className="text-sm text-white/75 hover:text-white transition-colors"
              >
                Why This Matters
              </button>
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-full border border-white/35 text-white hover:bg-white hover:text-[#18251F] transition-all duration-300"
              >
                Get Involved
              </button>
            </nav>
            ...
            {[
              ...
              >
                ...
                <div className="mt-12">
                  ...
                  <div className="text-[#788079] mt-1">{stat.desc}</div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 border-t border-[#CBC5B7]">
            ...
            <div className="group py-10 lg:pr-10 border-b lg:border-b-0 lg:border-r border-[#CBC5B7]">
              <div className="flex items-center justify-between mb-10">
                <span className="font-serif text-lg text-[#9B8A6A]">01</span>
            ...
            <div className="group py-10 lg:px-10 border-b lg:border-b-0 lg:border-r border-[#CBC5B7]">
              <div className="flex items-center justify-between mb-10">
                <span className="font-serif text-lg text-[#9B8A6A]">02</span>
            ...
            <div className="group py-10 lg:pl-10">
              <div className="flex items-center justify-between mb-10">
                <span className="font-serif text-lg text-[#9B8A6A]">03</span>
