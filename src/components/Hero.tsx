...
const Hero: React.FC<HeroProps> = ({ onPartnerWithUs }) => {
  ...
  return (
    ...
    >
      ...
      {/* =========================
          HERO
          ========================= */}
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#102019]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-[#08120E]/60" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#08120E]/95 via-[#08120E]/70 to-[#08120E]/25" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#08120E]/90 via-transparent to-[#08120E]/10" />
        </div>
        ...
        {/* Editorial circles */}
        <div className="absolute right-[-180px] top-[18%] w-[560px] h-[560px] rounded-full border border-white/[0.08]" />
        <div className="absolute right-[-50px] top-[29%] w-[360px] h-[360px] rounded-full border border-white/[0.08]" />
        <div className="absolute right-[75px] top-[40%] w-[135px] h-[135px] rounded-full border border-[#F2C230]/20" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 w-full py-36 pt-44">
          <div className="max-w-5xl">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-[11px] tracking-[0.35em] text-white/70 uppercase font-medium">
                Research Initiative
              </span>
            </div>

            <h1 className="text-white leading-[0.94] tracking-[-0.04em]">

              <span className="block font-serif text-xl sm:text-2xl md:text-3xl font-light text-white/65 mb-6 tracking-[0.06em]">
                Documenting African Social Enterprise
              </span>

              <span className="block font-serif text-5xl sm:text-6xl md:text-7xl lg:text-[88px] font-medium">
                <Typewriter
            ...
            <p className="text-base sm:text-lg md:text-xl text-white/70 mt-8 mb-11 max-w-2xl leading-[1.8] font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                className="group px-8 py-4 bg-[#F7F5EF] text-[#18251F]
              ...
              <button
                className="px-8 py-4 border border-white/35 text-white
                  rounded-full hover:bg-white/10 hover:border-white/70
                  transition-all duration-300
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
          <div className="flex flex-col items-center gap-2">
            <span className="text-white/40 text-[9px] tracking-[0.4em]">
              SCROLL
            </span>
        ...
        <div className="max-w-7xl mx-auto py-24 sm:py-32 px-5 sm:px-8 lg:px-10">
          ...
          <div className="grid lg:grid-cols-[0.6fr_1.4fr] gap-12 items-end mb-16">
            ...
            <div>
              <div className="flex items-center gap-3 mb-5">
                <span className="text-[11px] tracking-[0.3em] text-[#6D7B73]">
                  01
                </span>
              ...
              <h2 className="font-serif text-4xl md:text-5xl text-[#18251F] tracking-[-0.02em]">
                Our Impact
              </h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 border-t border-[#CBC5B7]">
            ...
            {stats.map((stat, idx) => (
              <div
                key={idx}
                className="group relative py-10 md:py-12 md:px-9
                  first:md:pl-0 last:md:pr-0
                  border-b md:border-b-0 md:border-r
                  last:border-r-0 border-[#CBC5B7]
                  hover:bg-[#F3F0E8] transition-colors duration-500"
              >
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div
                    className="w-11 h-11 rounded-full border border-[#C8C1B3]
                      flex items-center justify-center
                      group-hover:bg-[#18251F]
                      group-hover:text-white
                      group-hover:border-[#18251F]
        ...
        <div className="max-w-7xl mx-auto py-24 sm:py-32 px-5 sm:px-8 lg:px-10">
          ...
          <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-14 lg:gap-24 items-start">
            ...
            <div>
              ...
              <h2 className="font-serif text-4xl md:text-5xl text-[#18251F] mb-8 tracking-[-0.02em]">
                About the Founder
              </h2>
              ...
              <div className="relative rounded-sm overflow-hidden border border-[#D2CCBD] shadow-xl">
                ...
                <div className="h-[390px] bg-gradient-to-br from-[#D8E4DB] via-[#C4D4C9] to-[#AFC2B5] flex items-center justify-center">

                  <div className="text-center">

                    <div className="w-24 h-24 rounded-full bg-white/45 flex items-center justify-center mx-auto mb-4 shadow-lg">
                      <Users className="h-12 w-12 text-[#557064]" />
                    </div>

                    <div className="text-[#405048] font-medium">
                      Founder Photo
                    </div>
              ...
              <div className="mt-8 space-y-3">
                ...
                <div className="group flex items-start p-4 bg-[#F7F5EF] border border-[#D5D0C3] hover:border-[#159447] hover:-translate-y-0.5 transition-all duration-300">
                ...
                <div className="group flex items-start p-4 bg-[#F7F5EF] border border-[#D5D0C3] hover:border-[#1677C8] hover:-translate-y-0.5 transition-all duration-300">
                ...
                <div className="group flex items-start p-4 bg-[#F7F5EF] border border-[#D5D0C3] hover:border-[#D6AD22] hover:-translate-y-0.5 transition-all duration-300">
            ...
            <div className="lg:pt-16">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg sm:text-xl text-[#5F6B65] leading-[1.8]">
                ...
                <p className="text-lg sm:text-xl text-[#5F6B65] leading-[1.8]">
                  ...
                  documenting their experiences and challenges.
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 border-t border-[#CBC5B7]">
            ...
            <div className="group py-10 lg:pr-10 border-b lg:border-b-0 lg:border-r border-[#CBC5B7]">
              ...
              <div className="flex items-center justify-between mb-10">
                ...
                <div className="w-12 h-12 rounded-full border border-[#C3BCAD] flex items-center justify-center group-hover:bg-[#159447] group-hover:text-white group-hover:border-[#159447] transition-all duration-500">
            ...
            <div className="group py-10 lg:px-10 border-b lg:border-b-0 lg:border-r border-[#CBC5B7]">
              ...
              <div className="flex items-center justify-between mb-10">
                ...
                <div className="w-12 h-12 rounded-full border border-[#C3BCAD] flex items-center justify-center group-hover:bg-[#1677C8] group-hover:text-white group-hover:border-[#1677C8] transition-all duration-500">
            ...
            <div className="group py-10 lg:pl-10">
              ...
              <div className="flex items-center justify-between mb-10">
                ...
                <div className="w-12 h-12 rounded-full border border-[#C3BCAD] flex items-center justify-center group-hover:bg-[#F2C230] group-hover:text-[#18251F] group-hover:border-[#F2C230] transition-all duration-500">
          ...
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-14 lg:gap-20">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="text-[11px] tracking-[0.3em] text-[#F2C230]">
                  04
                </span>
              ...
              <h3 className="font-serif text-5xl md:text-6xl text-[#F0EADF] leading-[0.95] tracking-[-0.03em]">
                Why This <span className="italic text-[#F2C230]">Matters</span>
              </h3>

              <div className="w-14 h-px bg-[#F2C230] mt-7" />

              <p className="text-lg text-white/60 max-w-md mt-7 leading-relaxed">
                Understanding the critical gaps in African social entrepreneurship research
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-white/15">
              ...
              <div className="py-9 md:px-7 md:border-r border-white/15">
                ...
                <p className="text-white/55 leading-relaxed">
                  Existing research often overlooks lived realities,
                  founder decision-making, and long-term sustainability.
                </p>
      ...
      <div id="contact" className="bg-[#EAE5DA]">
        ...
        <div className="max-w-5xl mx-auto py-24 sm:py-32 px-5 sm:px-8 lg:px-10">
          ...
          <div className="text-center">
            ...
            <h3 className="font-serif text-4xl md:text-6xl text-[#18251F] mb-7 leading-tight tracking-[-0.03em]">
            ...
            <p className="text-lg text-[#66716B] mb-10 max-w-2xl mx-auto leading-relaxed">
              Contribute to building a more comprehensive understanding of African social entrepreneurship.
            </p>
            ...
            <div className="flex justify-center">
              ...
              <button
                className="px-10 py-4 border border-[#A9A08F]
                  text-[#39463F] rounded-full
                  hover:bg-[#F7F5EF]
                  hover:border-[#102019]
                  hover:-translate-y-1
