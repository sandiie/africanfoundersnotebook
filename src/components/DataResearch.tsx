...
const DataResearch: React.FC<DataResearchProps> = ({ onBack }) => {
  return (
    <section id="data-research" className="bg-gradient-to-br from-gray-50 via-white to-gray-50 py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 mb-20">
          ...
          <div className="lg:w-1/2">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-100 to-amber-50 mb-6 border border-amber-200">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Card 1 with Photo */}
            <div className="group">
              <div className="rounded-2xl overflow-hidden border border-gray-200 mb-6 h-48">
                <img 
